    ...
    <section className={styles.wrapper}>
      ...
      <div className={styles.content}>
        <p className={styles.text}>
          Xen is&nbsp;a&nbsp;locally running, privacy-focused AI&nbsp;assistant
          designed to&nbsp;integrate seamlessly into your digital life. Built
          by&nbsp;a&nbsp;global community of&nbsp;developers and privacy
          advocates, Xen isn&rsquo;t just another chatbot&nbsp;&mdash;
          it&rsquo;s your trusted co-pilot in&nbsp;the age of&nbsp;intelligent
          automation.
        </p>
